...
namespace gp_6
{
    public partial class Form1 : Form
    {
        ...
        private void Render()
        {
            ...
            device.Transform.View = Matrix.LookAtLH(new Vector3(0, 0, 30), new Vector3(1, 0, 0), new Vector3(0, 5, 0));

            CustomVertex.PositionNormalColored[] vertices = new CustomVertex.PositionNormalColored[5];
            ...
            device.Transform.World = Matrix.Translation(-5, -10 * 1 / 3, 0) * Matrix.RotationAxis(new Vector3(), 0);
